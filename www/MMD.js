...
(function() {
  ...
  this.MMD = (function() {
    ...
    MMD.prototype.initParameters = function() {
      ...
      this.distance = this.DIST = 15;
      this.center = [0, 17, 0];
      this.fovy = 40;
      this.drawEdge = true;
      this.edgeThickness = 0.0003;
      this.edgeColor = [0, 0, 0];
      this.lightDirection = [0.7, 0.3, 0.8];
      this.lightDistance = 8875;
      this.lightColor = [0.1, 0.0, 0.0];
    ...
    MMD.prototype.play = function() {
      this.playing = this.isPlaying = true;
    };

    MMD.prototype.pause = function() {
      this.playing = this.isPlaying = false;
    };
